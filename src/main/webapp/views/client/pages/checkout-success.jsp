...
<div class="ScriptTop">
    ...
    <div class="rt-container">
      <div class="col-rt-12">
        <div class="rt-heading">
          <h1>Trang thanh toán Udemy</h1>
          <p>Thanh toán đơn hàng ${checkoutId} thành công</p>
        </div>
      </div>
    </div>
  </header>
  ...
  <section>
	...
	C131.967,94.755,132.296,93.271,131.583,92.152z" />
            ...
            <div id='lower-side'>
              <p id='message'>
                Xin chúc mừng, đơn hàng của bạn đã được thanh toán thành công
              </p>
              <a href="/courses" id="contBtn">Tiếp tục mua sắm</a>
            </div>
          </div>
          <!-- partial -->
