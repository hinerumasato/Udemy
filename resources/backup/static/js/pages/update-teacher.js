(async function() {
    const updateTeacherUploadImg = document.getElementById('updateTeacherUploadImg');
    ...
    const renderIcon = blob => {
        ...
        updateTeacherUploadImg.src = blobUrl;
    ...
    const handleInvoke = async () => {
        const iconLink = updateTeacherUploadImg.getAttribute('upload-link');
